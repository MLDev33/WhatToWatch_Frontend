...
const ListScreen = ({ navigation }) => {
  ...
  console.log(list, "lists in listscreen");
  ...
  let firstAvatar =
    "https://res.cloudinary.com/ddr0yckcq/image/upload/v1725521994/tv_ydg3zn.png";
  ...
  console.log("userlist", JSON.stringify(userLists, null, 2));
    ...
    fetch(`${baseUrl}movielists/user/lists/${userToken}`) // corriger dans users le "s" en trop ici et en backend
      ...
      .then(
        ...
        function (rejectionReason) {
          // 3 - etape pour fix l'erreur format token non reconnu
          console.log(
            "Error parsing JSON from response:",
            rejectionReason,
            responseClone
          ); // 4 - etape pour fix l'erreur format token non reconnu
          responseClone
            .text() // 5 - etape pour fix l'erreur format token non reconnu
            .then(function (bodyText) {
              console.log(
                "Received the following instead of valid JSON:",
                bodyText
              ); // 6 - etape pour fix l'erreur format token non reconnu -> voir les infos dans le terminal l'erreur ne s'affiche plus
            });
        }
      )
      .catch((error) => {
          ...
          {loadingLikes ? (
            ...
            >
              ...
              <View style={styles.likesInfo}>
                ...
                <Text style={styles.likesDetails}>
                  {yourLikes.length} titles
                </Text>
              </View>
              <FontAwesome
                name="heart"
            ...
            {loadingLists ? (
                ...
                >
                  <View style={styles.listCardInfosContainer}>
                    ...
                    <View style={styles.listCardTextContainer}>
                      <Text style={styles.listCardTextTitle}>
                        {list.list_name}
                      </Text>
                      <Text style={styles.listCardTextLength}>
              ...
              <View style={styles.textAddListContainer}>
                ...
                <Text style={styles.textBody14}>
                  Create a custom collection of series, movies, from your
                  favorite streaming platforms. Share your picks with friends
